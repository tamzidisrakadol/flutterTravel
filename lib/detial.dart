...
import 'package:travel_blog/model/traveldetails.dart';

class DetailPage extends StatelessWidget {
  final Travel travel;
  final TravelDesc travelDesc;
  final double expandedHeight = 300;
  final double roundedContainerHeight = 50;
  DetailPage({required this.travel,required this.travelDesc});
  @override
